                ...
                <div className="container ">
                    ...
                    <div className="info p-5">
                        ...
                        <div className="each d-flex position-relative my-3 ">
                            <div className='firstbox z-3 d-none d-md-block '>
                                <img src="./../../../images/mrdavid.png" alt="" />
                            </div>

                            <div className=' secondbox  z-0 py-5 pe-5'>
                                <div className="d-flex flex-column flex-md-row">
                                    <img src="./../../../images/opicon.png" alt="" />
                                    <div>
                                        <h5 className='h3'>Conducive learning atmosphere</h5>
                        ...
                        <div className="each d-flex position-relative my-5 ">
                            <div className=' secondbox  z-0 py-5 pe-5'>
                                <div className="d-flex flex-column flex-md-row">
                                    ...
                                    <div>
                                        <h5 className='h3'>Hands on practice everyday</h5>
                        ...
                        <div className="each d-flex position-relative my-3 ">
                            ...
                            <div className=' secondbox  z-0 py-5 pe-5'>
                                <div className="d-flex flex-column flex-md-row">
                                    ...
                                    <div>
                                        <h5 className='h3'>Learn from senior faculties</h5>
                        ...
                        <div className="each d-flex position-relative my-5 ">
                            <div className=' secondbox  z-0 py-5 pe-5'>
                                <div className="d-flex flex-column flex-md-row">
                                    ...
                                    <div>
                                        <h5 className='h3'>Project and Profiles</h5>
