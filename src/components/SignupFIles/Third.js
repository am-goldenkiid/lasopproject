...
function Third() {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      ?.post(`${process.env.REACT_APP_API_URL}/receipt/${id}`, form)
      .then((response) => {
        if (
          response?.data?.message ===
          "Congratulations, Your application is in process"
        ) {
    ...
    >
      <div className="container-fluid">
        ...
        <div className="p-md-5 ">
          ...
          <small className="info p d-flex justify-content-center text-center mt-5">
